...
func main() {
	...
	// r.GET("/api/v1/location-details/pdf", middleware.AuthMiddleware("admin"), handlers.DownloadDeviceLocationDetail(db))
	...
	// r.GET("/api/v1/owner-details/pdf", middleware.AuthMiddleware("admin"), handlers.DownloadDeviceAMCOwnerDetail(db))
	...
	// r.GET("/api/v1/power-details/pdf", middleware.AuthMiddleware("admin"), handlers.DownloadDevicePowerDetail(db))
	...
	// r.GET("/api/v1/fiber-details/pdf", middleware.AuthMiddleware("admin"), handlers.DownloadDeviceEthernetFiberDetail(db))
