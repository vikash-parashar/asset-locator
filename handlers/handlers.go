...
// DeleteDeviceFiberDetailHandler deletes a DeviceFiberDetail record based on its ID.
func GenerateFiberDataExcel(db *db.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err = utils.GenerateExcelFile(data, "fiber.xlsx"); err != nil {
			log.Println(err)
			return
		}
	}
...
func GeneratePowerDataExcel(db *db.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err = utils.GenerateExcelFile(data, "power.xlsx"); err != nil {
			log.Println(err)
			return
		}
	}
...
// DeleteDeviceOwnerDetailHandler deletes a DeviceOwnerDetail record based on its ID.
func GenerateOwnerDataExcel(db *db.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err = utils.GenerateExcelFile(data, "owner.xlsx"); err != nil {
			log.Println(err)
			return
		}
	}
