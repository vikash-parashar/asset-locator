...
// 		var data1 []*models.DeviceAMCOwnerDetail
// 		var data2 []*models.DeviceEthernetFiberDetail
// 		var data3 []*models.DeviceLocationDetail
// 		var data4 []*models.DevicePowerDetail
// 		var err error

// 		switch page {
// 		case "1":
// 			data1, err = db.FetchDataFromTable1()
// 		case "2":
// 			data2, err = db.FetchDataFromTable2()
// 		case "3":
// 			data3, err = db.FetchDataFromTable3()
// 		case "4":
// 			data4, err = db.FetchDataFromTable4()
...
// 		// Generate the PDF
// 		pdf := utils.GeneratePDFFile(data)

// 		// Serve the generated PDF to the user
// 		c.Writer.Header().Set("Content-Type", "application/pdf")
// 		c.Writer.Header().Set("Content-Disposition", "attachment; filename=output.pdf")
// 		pdf.Output(c.Writer)
// 	}
// }
